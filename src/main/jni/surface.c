...
Java_com_zing_zalo_gifplayer_GifInfoHandle_bindSurface(JNIEnv *env, jclass __unused handleClass, jlong gifInfo,
...
__unused JNIEXPORT void JNICALL
Java_com_zing_zalo_gifplayer_GifInfoHandle_postUnbindSurface(JNIEnv *env, jclass __unused handleClass, jlong gifInfo) {
	GifInfo *info = (GifInfo *) (intptr_t) gifInfo;
